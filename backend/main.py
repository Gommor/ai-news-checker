...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:3000",
        "http://127.0.0.1:3000",
        "https://www.deepverify.online",
        "https://deepverify.online",
    ],
...
def _normalize_decision(decision: str, lang: str) -> str:
    raw = re.sub(r"\s+", " ", (decision or "").strip())
    if not raw:
        return "Uncertain" if lang == "EN" else "Şüpheli"

    lowered = raw.lower()
    template_like = "/" in raw and (
